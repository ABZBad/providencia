...
(
	...
	@cantidad numeric(3), 
	@usuario varchar(20), 
	@agrupador numeric(10), --id que se incrementa en el load de la forma 
...
BEGIN
	...
	IF (@EXIST>=@cantidad)
		BEGIN
			...
			SELECT TOP 1 @COSTO = COSTO FROM aspel_sae50.dbo.MINVE01 WHERE CVE_ART = @CVE_ART AND CVE_CPTO = 1 AND COSTO > 0
