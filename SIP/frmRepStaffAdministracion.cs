...
namespace SIP
{
    public partial class frmRepStaffAdministracion : Form
    {
        private BackgroundWorker bgw;
        private Precarga precarga;
        private Exception ex;
        public frmRepStaffAdministracion()
        {
            InitializeComponent();
        ...
        void bgw_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            DataSet dsRepStaff = RepStaff.RegresaDatosReporteStaffAdministracion(dtFechaDesde.Value, dtFechaHasta.Value, ref ex);
            if (ex == null)
            {
                if (dsRepStaff != null)
                {
                    ...
                    RepStaff.GeneraArchivoExcelAdministracion(archivoTemporal, dsRepStaff, dtFechaDesde.Value, dtFechaHasta.Value);
