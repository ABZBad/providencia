...
namespace SIP
{
    public partial class frmRepCostoVsPrecCostura : Form
    {
        private Precarga precarga;
        public frmRepCostoVsPrecCostura()
        {
            InitializeComponent();
        ...
        {
            precarga.AsignastatusProceso("Procesando Costo Vs Prec. Costura...");


            DataTable CostoVsPrecCostura = RepCostoVsPrecCostura.RegresaCostoVsPrecCostura(dtpIni.Value, dtpFin.Value);
            ...
            RepCostoVsPrecCostura.GeneraArchivoExcel(archivoTemporal, CostoVsPrecCostura);
