...
namespace SIP
{
    public partial class frmRepFolAnt : Form
    {
        ...
        public frmRepFolAnt(Enumerados.AreasEmpresa TipoArea)
        {
            InitializeComponent();
        ...
        void backGroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            precarga.AsignastatusProceso("Procesando fact. anterior...");
            DataTable dataTableFacAnt = factFoliosAntPrendas.RegresaTablaFacturacionAnt(Enumerados.TipoReporteFolios.Anteriores, this.TipoArea, dtpIni.Value, dtpFin.Value);
            precarga.AsignastatusProceso("Procesando notas de crédito...");
            DataTable dataTableNotas = factFoliosAntPrendas.RegresaTablaNotasCredito(Enumerados.TipoReporteFolios.Anteriores, dtpIni.Value, dtpFin.Value);
