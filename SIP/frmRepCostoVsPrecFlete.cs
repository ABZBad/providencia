...
namespace SIP
{
    public partial class frmRepCostoVsPrecFlete : Form
    {
        private Precarga precarga;
        public frmRepCostoVsPrecFlete()
        {
            InitializeComponent();
        ...
        {
            precarga.AsignastatusProceso("Procesando Costo Vs Prec. Flete...");


            DataTable CostoVsPrecFlete = RepCostoVsPrecFlete.RegresaCostoVsPrecFlete(dtpIni.Value, dtpFin.Value);
            ...
            RepCostoVsPrecFlete.GeneraArchivoExcel(archivoTemporal, CostoVsPrecFlete);
