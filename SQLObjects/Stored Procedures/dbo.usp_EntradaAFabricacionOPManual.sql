...
*/
CREATE PROCEDURE [dbo].[usp_EntradaAFabricacionOPManual]
(
	@idPedido varchar(12),
			...
			BEGIN
				...
				ELSE
					BEGIN
						...
						set @resultado= 'No hay existencia suficiente de '+ @CVE_ART + ' se requieren ' + convert(varchar(15), @REQUERIMIENTO) + ' y en el almacen 2 sólo hay ' + convert(varchar(5), @EXIST)
					END
			END
		ELSE
			BEGIN
