...
SET ANSI_NULLS ON
GO
CREATE VIEW dbo.vw_FactDFoliosAnt
AS
...
FROM         aspel_sae50.dbo.CLIE01 LEFT OUTER JOIN
                      aspel_sae50.dbo.FACTD01 AS FACTF ON LTRIM(RTRIM(aspel_sae50.dbo.CLIE01.CLAVE)) = LTRIM(RTRIM(FACTF.CVE_CLPV))
WHERE     (FACTF.STATUS <> 'C') AND (FACTF.TIP_DOC = 'D')
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vw_FactDFoliosAnt', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vw_FactDFoliosAnt', NULL, NULL
GO
